## TechDegree Project 11: React Flickr Gallery

In order to use this project you have to have a Flickr API key, then you need to create a `.env` file in the root directory as follow:

```
REACT_APP_API = 'YOUR API KEY'
```
Please note: do NOT add any comma or semicolon at the end of the line.
